 ...
 * @author sunny
 */
public class SearchInvoice2 extends javax.swing.JFrame {
...
//Program to set single instance of ManageClients
    private static SearchInvoice2 obj = null;

    public static SearchInvoice2 getObj() {
        if (obj == null) {
            obj = new SearchInvoice2();
        }
        return obj;
    }
    ...
    public void getData1() {
        try {
            String sql = "SELECT invoiceno AS 'INVOICE NO.',joborderno AS 'JOB ORDER NO.',date AS 'DATE',company AS 'COMPANY', productname AS 'PRODUCT NAME',processname AS 'PROCESS',materialname As 'MATERIAL',"
                    ...
                    + "amount As 'AMOUNT',remark AS 'REMARK' FROM invoice2master WHERE company LIKE '%" + cmbCompany.getSelectedItem() + "%' ORDER BY inv_uid DESC";
    ...
    public void getData2() {
        try {
            String sql = "SELECT invoiceno AS 'INVOICE NO.',joborderno AS 'JOB ORDER NO.',date AS 'DATE',company AS 'COMPANY', productname AS 'PRODUCT NAME',processname AS 'PROCESS',materialname As 'MATERIAL',"
                    + "tstrt AS 'T/START',w AS 'W',od AS 'OD',tl AS 'TL',mdp AS 'MDP',qty AS 'QTY',rate AS 'RATE',discountper AS 'DISC%',discountamt AS 'DISC.AMT',"
                    + "amount As 'AMOUNT',remark As 'REMARK'FROM invoice2master WHERE company LIKE '%" + cmbCompany.getSelectedItem() + "%' AND "
...
getData2();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SearchInvoice2.class.getName() ).log( java.util.logging.Level.SEVERE, null, ex );
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new SearchInvoice2().setVisible( true );
            }
        } );
    }
