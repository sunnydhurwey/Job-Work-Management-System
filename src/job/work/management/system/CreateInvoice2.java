...
//            } else {
//                try {
//                    String sql = "SELECT * FROM invoice2,invoice2master,companydetails WHERE invoice2.invoiceno='" + txtInvoiceNo.getText() + "' AND invoice2master.invoiceno='" + txtInvoiceNo.getText() + "' AND companydetails.c_uid=(SELECT MAX(companydetails.c_uid) FROM companydetails)";
//                    JasperDesign jd = JRXmlLoader.load( "src/reports/invoice2PT.jrxml" );
//                    JRDesignQuery qry = new JRDesignQuery();
//                    qry.setText( sql );
//                    jd.setQuery( qry );
