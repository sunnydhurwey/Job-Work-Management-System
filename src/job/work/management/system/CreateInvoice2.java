...
public class CreateInvoice2 extends javax.swing.JFrame {
    ...
    public void getDataToTable() {
        try {
            String sql = "SELECT * FROM joborder2 WHERE invoiceno='" + txtInvoiceNo.getText() + "'";
            pst = conn.prepareStatement( sql );
            rs = pst.executeQuery();
    ...
    public void getJobOrderDataCALC() {
        try {
            ...
            if (rs2.next()) {
                ...
                txtDiscountPer.setText( rs2.getString( "discount" ) );
...
//                txtAreaTC.setText(rs2.getString("termsconditions"));
    ...
    public void addProduct() {
        try {
            String sql = "INSERT INTO joborder2 (invoiceno,date,clientname,productname,processname,materialname,t,w,od,tl,m,dp,std,qty,rate,"
...
//            getData();
    ...
    public void getTableDataToField() {
        try {
            ...
            String sql = "SELECT * FROM joborder2 WHERE uid='" + tblClick + "'";
    ...
    public void deleteProduct() {
        try {
            String sql = "DELETE FROM joborder2 WHERE uid='" + tblClick + "'";
            pst = conn.prepareStatement( sql );
            pst.execute();
...
//            getData();
    ...
    double gstper = 0, discount = 0, subtotal = 0, gstamt = 0, grandTotal = 0, discountper = 0;
    ...
    public void calcGT() {
        ...
        if (txtDiscountPer.getText() != null || !"".equals( txtDiscountPer.getText() )) {
            discountper = Double.parseDouble( txtDiscountPer.getText() );
        } else {
            discountper = 0;
        }
        discount = (basicprice * discountper) / 100;
    ...
    public void saveInvoice() {
        try {
            String sql = "INSERT INTO invoice2 (invoiceno,date,clientname,company,address,email,mobile,landline,gstin,basicprice,"
                    + "discount,subtotal,gstper,gstamt,totalamt,termsconditions) VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)";
            pst = conn.prepareStatement( sql );
            pst.setString( 1, txtInvoiceNo.getText() );
            pst.setString( 2, ((JTextField) jDateChooser1.getDateEditor().getUiComponent()).getText() );
            pst.setString( 3, cmbClientName.getEditor().getItem().toString() );
            ...
            pst.setString( 11, txtDiscountPer.getText() );
    ...
    public void updateInvoice() {
        try {
            String sql = "UPDATE invoice2 SET date=?,clientname=?,company=?,address=?,email=?,mobile=?,"
            ...
            pst.setString( 10, txtDiscountPer.getText() );
            ...
            pst.setString( 15, txtAreaTC.getText() );
            pst.execute();
    ...
    //Function or method to delete joborder2
    public void deleteJobOrder() {
        try {
            String sql = "DELETE FROM joborder2 WHERE invoiceno='" + txtInvoiceNo.getText() + "'";
            pst = conn.prepareStatement( sql );
            pst.execute();
        } catch (SQLException e) {
            JOptionPane.showMessageDialog( null, "deleteJobOrder() Exception", "Invoice Deleted", JOptionPane.ERROR_MESSAGE );
        } finally {
            try {
                rs.close();
                pst.close();
    ...
    public void printOptions() {
        try {
            ...
            if (x == 0) {
                try {
                    String sql = "Select * from joborder2,companydetails,invoice2 WHERE joborder2.invoiceno='" + invno + "' "
                            + "AND invoice2.invoiceno='" + invno + "' AND companydetails.c_uid=(SELECT max(c_uid) FROM companydetails)";
                    JasperDesign jd = JRXmlLoader.load( "src/reports/invoice2LS.jrxml" );
    ...
    private void initComponents() {
        ...
        cmbClientName.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0)));
        ...
        cmbCompany.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0)));
        ...
        cmbAddress.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0)));
        ...
        cmbEmail.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0)));
        ...
        cmbMobile.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0)));
        ...
        cmbLandline.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0)));
        ...
        cmbGSTIN.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0)));
        ...
        cmbProcess.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0)));
        ...
        cmbMaterial.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0)));
        ...
        jPanel3Layout.setVerticalGroup(
            ...
            .addGroup(jPanel3Layout.createSequentialGroup()
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE, false)
                    .addComponent(jLabel5)
                    .addComponent(cmbProductName, javax.swing.GroupLayout.PREFERRED_SIZE, 25, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(jLabel27, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                    .addComponent(cmbProcess, javax.swing.GroupLayout.PREFERRED_SIZE, 25, javax.swing.GroupLayout.PREFERRED_SIZE)
                ...
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(btnAddMaterialName, javax.swing.GroupLayout.Alignment.TRAILING)
                    .addGroup(jPanel3Layout.createSequentialGroup()
                        .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(jLabel28)
                            .addComponent(cmbMaterial, javax.swing.GroupLayout.PREFERRED_SIZE, 25, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        jPanel4Layout.linkSize(javax.swing.SwingConstants.VERTICAL, new java.awt.Component[] {jDateChooser1, jLabel31, jLabel7, txtInvoiceNo});
        ...
        txtDiscountPer.setHorizontalAlignment(javax.swing.JTextField.CENTER);
        txtDiscountPer.setText("0");
        txtDiscountPer.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0)));
        ...
        setSize(new java.awt.Dimension(1172, 704));
    ...
    private void txtDiscountPerKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtDiscountPerKeyReleased
        // TODO add your handling code here:
        if (!"".equals( txtDiscountPer.getText() )) {
            calcGT();
        } else {
            txtDiscountPer.setText( "0" );
            calcGT();
...
//            getQuotationDataCALC();
    ...
    private void txtSTDKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtSTDKeyPressed
        // TODO add your handling code here:
        if (evt.getKeyChar() == KeyEvent.VK_ENTER) {
            txtRate.requestFocus();
        }
    }//GEN-LAST:event_txtSTDKeyPressed
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger( CreateInvoice2.class.getName() ).log( java.util.logging.Level.SEVERE, null, ex );
