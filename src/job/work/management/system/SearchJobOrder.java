 ...
 * @author sunny
 */
public class SearchJobOrder extends javax.swing.JFrame {
...
//Program to set single instance of ManageClients
    private static SearchJobOrder obj = null;

    public static SearchJobOrder getObj() {
        if (obj == null) {
            obj = new SearchJobOrder();
        }
        return obj;
    }
    ...
    public void getData1() {
        try {
            String sql = "SELECT joborderno AS 'JOB ORDER NO.',date AS 'DATE',company AS 'COMPANY', productname AS 'PRODUCT NAME',processname AS 'PROCESS',materialname As 'MATERIAL',"
                    + "tstrt AS 'T/START',w AS 'W',od AS 'OD',tl AS 'TL',mdp AS 'MDP',qty AS 'QTY',rate AS 'RATE',discountper AS 'DISC%',discountamt AS 'DISC.AMT',"
                    + "amount As 'AMOUNT',remark AS 'REMARK' FROM jobordermaster WHERE company LIKE '%" + cmbCompany.getSelectedItem() + "%' ORDER BY uid DESC";
            pst = conn.prepareStatement( sql );
            rs = pst.executeQuery();
            tblSearchJobOrder.setModel( DbUtils.resultSetToTableModel( rs ) );
    ...
    public void getData2() {
        try {
            String sql = "SELECT joborderno AS 'JOB ORDER NO.',date AS 'DATE',company AS 'COMPANY', productname AS 'PRODUCT NAME',processname AS 'PROCESS',materialname As 'MATERIAL',"
                    + "tstrt AS 'T/START',w AS 'W',od AS 'OD',tl AS 'TL',mdp AS 'MDP',qty AS 'QTY',rate AS 'RATE',discountper AS 'DISC%',discountamt AS 'DISC.AMT',"
                    + "amount As 'AMOUNT',remark As 'REMARK'FROM jobordermaster WHERE company LIKE '%" + cmbCompany.getSelectedItem() + "%' AND "
                    + "productname LIKE '%" + cmbProductName.getSelectedItem() + "%' ORDER BY uid DESC";
            pst = conn.prepareStatement( sql );
            rs = pst.executeQuery();
            tblSearchJobOrder.setModel( DbUtils.resultSetToTableModel( rs ) );
        } catch (SQLException e) {
    ...
    public void getData3() {
        try {
            String sql = "SELECT joborderno AS 'JOB ORDER NO.',date AS 'DATE',company AS 'COMPANY', productname AS 'PRODUCT NAME',processname AS 'PROCESS',materialname As 'MATERIAL',"
                    + "tstrt AS 'T/START',w AS 'W',od AS 'OD',tl AS 'TL',mdp AS 'MDP',qty AS 'QTY',rate AS 'RATE',discountper AS 'DISC%',discountamt AS 'DISC.AMT',"
                    + "amount As 'AMOUNT',remark As 'REMARK'FROM jobordermaster WHERE company LIKE '%" + cmbCompany.getSelectedItem() + "%' AND "
                    + "productname LIKE '%" + cmbProductName.getSelectedItem() + "%' AND tstrt='" + txtTSTRT.getText() + "' ORDER BY uid DESC";
            pst = conn.prepareStatement( sql );
            rs = pst.executeQuery();
            tblSearchJobOrder.setModel( DbUtils.resultSetToTableModel( rs ) );
        } catch (SQLException e) {
    ...
    public void getData4() {
        try {
            String sql = "SELECT joborderno AS 'JOB ORDER NO.',date AS 'DATE',company AS 'COMPANY', productname AS 'PRODUCT NAME',processname AS 'PROCESS',materialname As 'MATERIAL',"
                    ...
                    + "tsrt='" + txtTSTRT.getText() + "' AND w='" + txtW.getText() + "' ORDER BY uid DESC";
            pst = conn.prepareStatement( sql );
            rs = pst.executeQuery();
            tblSearchJobOrder.setModel( DbUtils.resultSetToTableModel( rs ) );
        } catch (SQLException e) {
    ...
    private void initComponents() {
        ...
        tblSearchJobOrder = new javax.swing.JTable();
        ...
        tblSearchJobOrder.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
                {},
                {},
                {},
        ...
        jScrollPane1.setViewportView(tblSearchJobOrder);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SearchJobOrder.class.getName() ).log( java.util.logging.Level.SEVERE, null, ex );
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new SearchJobOrder().setVisible( true );
            }
        } );
    }
    ...
    private javax.swing.JTable tblSearchJobOrder;
