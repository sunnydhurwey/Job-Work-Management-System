...
//Program to set single instance of ManageClients
    private static SearchProformaInvoice obj = null;

    public static SearchProformaInvoice getObj() {
        if (obj == null) {
            obj = new SearchProformaInvoice();
        }
        return obj;
    }
    ...
    public void getData1() {
        try {
            String sql = "SELECT invoiceno AS 'INVOICE NO.',joborderno AS 'JOB ORDER NO.',date AS 'DATE',company AS 'COMPANY', productname AS 'PRODUCT NAME',processname AS 'PROCESS',materialname As 'MATERIAL',"
                    ...
                    + "amount As 'AMOUNT',remark AS 'REMARK' FROM proformainvoicemaster WHERE company LIKE '%" + cmbCompany.getSelectedItem() + "%' ORDER BY inv_uid DESC";
    ...
    public void getData2() {
        try {
            String sql = "SELECT invoiceno AS 'INVOICE NO.',joborderno AS 'JOB ORDER NO.',date AS 'DATE',company AS 'COMPANY', productname AS 'PRODUCT NAME',processname AS 'PROCESS',materialname As 'MATERIAL',"
                    + "tstrt AS 'T/START',w AS 'W',od AS 'OD',tl AS 'TL',mdp AS 'MDP',qty AS 'QTY',rate AS 'RATE',discountper AS 'DISC%',discountamt AS 'DISC.AMT',"
                    + "amount As 'AMOUNT',remark As 'REMARK'FROM proformainvoicemaster WHERE company LIKE '%" + cmbCompany.getSelectedItem() + "%' AND "
    ...
    private void initComponents() {
        ...
        setTitle("Search Proforma Invoice");
