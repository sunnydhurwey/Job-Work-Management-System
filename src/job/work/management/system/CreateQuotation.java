...
//            clearProductField();
    ...
    public void updateQuotation(){
        try {
            String sql = "UPDATE quotation SET quotationno=?,date=?,clientname=?,company=?,address=?,email=?,mobile=?,"
    ...
    public void printOptions(){
        try{
            ...
            String[] choice={"Complete Quotation"};
            ...
            if(x == 0){
                try{
                    String sql="Select * from quotation,joborder where quotation.quotationno='"+qno+"' "
                            + "AND joborder.quotationno='"+qno+"'";
                    JasperDesign jd= JRXmlLoader.load("src/reports/quotation.jrxml");
...
//            else{
//                try{
//                    String sql="Select * from QuotationTransactions,Quotations,Company,termsConditions where Quotations.s_InvoiceID='"+InvID+"' "
//                            + "AND QuotationTransactions.t_invoiceID='"+InvID+"'";
