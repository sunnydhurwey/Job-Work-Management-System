 ...
 * @author sunny
 */
public class SearchQuotation extends javax.swing.JFrame {
...
//Program to set single instance of ManageClients
    private static SearchQuotation obj = null;

    public static SearchQuotation getObj() {
        if (obj == null) {
            obj = new SearchQuotation();
        }
        return obj;
    }
    ...
    public void getData1() {
        try {
            String sql = "SELECT quotationno AS 'QUOTATION NO.',date AS 'DATE',company AS 'COMPANY', productname AS 'PRODUCT NAME',processname AS 'PROCESS',materialname As 'MATERIAL',"
                    + "tstrt AS 'T/START',w AS 'W',od AS 'OD',tl AS 'TL',mdp AS 'MDP',qty AS 'QTY',rate AS 'RATE',discountper AS 'DISC%',discountamt AS 'DISC.AMT',"
                    + "amount As 'AMOUNT',remark AS 'REMARK' FROM quotationmaster WHERE company LIKE '%" + cmbCompany.getSelectedItem() + "%' ORDER BY uid DESC";
    ...
    public void getData2() {
        try {
            String sql = "SELECT quotationno AS 'QUOTATION NO.',date AS 'DATE',company AS 'COMPANY', productname AS 'PRODUCT NAME',processname AS 'PROCESS',materialname As 'MATERIAL',"
                    + "tstrt AS 'T/START',w AS 'W',od AS 'OD',tl AS 'TL',mdp AS 'MDP',qty AS 'QTY',rate AS 'RATE',discountper AS 'DISC%',discountamt AS 'DISC.AMT',"
                    + "amount As 'AMOUNT',remark As 'REMARK' FROM quotationmaster WHERE company LIKE '%" + cmbCompany.getSelectedItem() + "%' AND "
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SearchQuotation.class.getName() ).log( java.util.logging.Level.SEVERE, null, ex );
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new SearchQuotation().setVisible( true );
            }
        } );
    }
